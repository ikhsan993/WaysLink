...
function SignUp() {
  ...
  return (
    <>
      <button className="btn text-light bg-yellow bold py-2 px-4 br" onClick={handleShow}>Register</button>
      <Modal show={show} onHide={handleClose}>
        <div className="container form-login mb-3 px-5">
          <form onSubmit={(e) => handleSubmit.mutate(e)}>
            ...
            <button className="login-btn py-3 mt-4 br">Sign Up</button>
          </form>
